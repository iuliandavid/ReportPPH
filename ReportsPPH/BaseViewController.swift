...
class BaseViewController: UIViewController, SlideMenuDelegate {
    ...
    func slideMenuItemSelected(atIndex : Int) {
        ...
        case 0:
            ...
            self.openViewControllerBasedOnIdentifier("Stocks")
            
            break
        case 1:
            print("Sales\n", terminator: "")
            
            self.openViewControllerBasedOnIdentifier("Sales")
    ...
    func openViewControllerBasedOnIdentifier(_ strIdentifier:String){
        let storyBoard = UIStoryboard(name: strIdentifier, bundle: nil)
    ...
    func onSlideMenuButtonPressed(_ sender : UIButton){
        if (sender.tag == 10)
        {
            ...
            self.slideMenuItemSelected(atIndex: -1);
